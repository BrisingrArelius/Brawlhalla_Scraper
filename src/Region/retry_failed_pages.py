...
• Works with the same folder layout as the main scraper:
      Data-22Jun/
...
• For every page in failed_pages.txt
      ...
      – if data comes back, append to both CSVs and delete that page
      – otherwise keep it in the file

• Uses exactly the same JSON-decoding logic as the main scraper.
"""
